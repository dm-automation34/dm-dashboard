...
const Container = styled.div<{ textHeight: number }>`
  ...
  height: calc(80vh - ${(props) => props.textHeight + 2}vh);
  width: 100%;
  max-width: 100vw;
                ...
                <table>
                  <tbody>
                    ...
                    <tr>
                      <td>OV</td>
                      <td>
                        {Math.round(parseFloat(machine1Data?.orderValue!))
                          ? Math.round(parseFloat(machine1Data?.orderValue!))
                          : "N/A"}
                      </td>
                    </tr>
                    <tr>
                      <td>AV</td>
                      <td>
                        {Math.round(parseFloat(machine1Data?.actualValue!))
                          ? Math.round(parseFloat(machine1Data?.actualValue!))
                          : "N/A"}
                      </td>
                    </tr>
                    <tr>
                      ...
                      <td>
                        {Math.round(
                          ((Math.round(
                            parseFloat(machine1Data?.actualValue!)
                          ) || 0) /
                            (Math.round(
                              parseFloat(machine1Data?.orderValue!)
                            ) || 0)) *
                            100
                        )}
                      </td>
